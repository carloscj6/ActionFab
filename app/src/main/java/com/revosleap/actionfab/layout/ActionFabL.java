...
import com.revosleap.actionfab.R;

import java.util.List;

public class ActionFabL extends FrameLayout implements View.OnClickListener  {
    ...
    public interface OnActionFabItemClick<T>{
        void onActionFabItemClick (int position, ActionItems<T> item);
    }
    public void setActionFabItemClick(OnActionFabItemClick onActionFabItemClick){
        this.actionFabItemClick=onActionFabItemClick;
    }

    public ActionFabL(@NonNull Context context) {
        this(context,null);
        this.context=context;
    }

    public ActionFabL(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
        this.context= context;
    }

    public ActionFabL(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setItems(List<ActionItems> actionItems){
        if (actionItems!=null){
    ...
    public void mainActionFab(ActionItems mainFab){
        if (mainFab!=null){
    ...
    private class ActionItemClick implements View.OnClickListener{
        private final ActionItems item;
        private final int position;

        ActionItemClick(ActionItems item, int position) {
            this.item = item;
